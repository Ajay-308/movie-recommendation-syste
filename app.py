...
df1 = pickle.load(open(r'/Users/useradmin/Desktop/movie_recommendation/recommendation_system/movie_list.pkl', 'rb'))
tfidf_matrix = pickle.load(open(r'/Users/useradmin/Desktop/movie_recommendation/recommendation_system/tfidf_matrix.pkl', 'rb'))
